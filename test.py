...
tokenizer = AutoTokenizer.from_pretrained("../../model/Qwen1.5-14B", trust_remote_code=True)
...
model = AutoModelForCausalLM.from_pretrained("../../model/Qwen1.5-14B", device_map="auto", trust_remote_code=True).eval()
